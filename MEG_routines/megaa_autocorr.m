...
numOutcomes = [258,86;359,78;176,63;240,45;343,51;238,48;368,89;376,42;269,55;292,32;375,79;327,72;294,49;200,55;287,45;398,73;199,52;397,83;260,54;416,61;389,77;393,69;334,88];
...
for s = 1:length(subs)
    ...
    for p = 1:numPerm
        for trl = 1:numTrials
            ...
            autocorr_trial_perm = [autocorr_trial_perm; epochLengthPos_1'; epochLengthPos_0'];
        end
    end
...
h2 = histogram(autocorr_trial_perm,'Normalization','probability'); xlim([0,12])
h1.BinWidth = 2;
h2.BinWidth = 2;
...
[h,p,ks2stat] = kstest2(autocorr_trial_real,autocorr_trial_perm);
