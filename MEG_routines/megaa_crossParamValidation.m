function out = megaa_crossParamValidation(par,folders,In)
%% -------------------------------------------------------------
...
for s = 1:length(par.subs)
    ...
    threatProb_bis = threatProb;
    threatMagn_bis = threatMagn;   
    ...
    tpRed = threatProb_bis(design(:,1));
    tmRed = threatMagn_bis(design(:,1));
    ...
    for t = 30:30
        ...
        for o = 0:5
            ...
            [foo_Coeff_Cau,foo_FitInfo_Cau] = lassoglm(x_train,y_Cau_red,'binomial','Alpha',1,'Lambda',optLasso(s)); % regression with Cau positive examples
            [foo_Coeff_Col,foo_FitInfo_Col] = lassoglm(x_train,y_Col_red,'binomial','Alpha',1,'Lambda',optLasso(s)); % regression with Col positive examples
